...
// MAIN COMPONENT
// ----------------------------------------------------------------------
export default function SectoralFocus() { // Changed to default export for consistency
    return (
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="mb-20 max-w-3xl">
                    ...
                    <h2 className="text-4xl md:text-6xl font-extrabold text-[#1A1A1A] mb-6 font-syne leading-tight">
                        Six Pillars of <br />
                        <span className="text-[#2C3E30]">Strategic Growth.</span>
                    </h2>
...
// SUB-COMPONENTS
// ----------------------------------------------------------------------
const SectorCard = ({ title, description, image, icon, delay }: any) => {
    return (
        <motion.div
        ...
        >
            ...
            <div className="absolute bottom-0 left-0 w-full p-8 flex flex-col justify-end">
                ...
                <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#A3E635] opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 delay-100">
                    Explore Opportunity <ArrowRightUp className="w-4 h-4" />
                </div>
            </div>
        </motion.div>
    );
