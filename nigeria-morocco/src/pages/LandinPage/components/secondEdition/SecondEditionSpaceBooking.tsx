        ...
        <section id="space" className="py-20 px-6 bg-white flex justify-center">
            ...
            >
                ...
                <div className="text-center md:text-left relative z-10 max-w-xl">
                  ...
                  {getTranslation("exhibitionTag", "Exhibition", "Exposition")}
              </span>
                    </div>

                    <h2 className="text-3xl md:text-4xl font-bold text-white font-syne mb-3">
                        {getTranslation("exhibitionHead", "Secure Your", "Réservez Votre")}{" "}
                        <span className="text-[#A3E635]">
                  {getTranslation("exhibitionSpace", "Exhibition Space?", "Espace d'Exposition ?")}
              </span>
                    </h2>
                    ...
                    <p className="text-[#DDE5D7]/80 text-sm md:text-base font-inter leading-relaxed">
                        {getTranslation(
                            "exhibitionBody",
                            "Position your brand at the center of Nigeria-Morocco trade relations. Showcase your products to high-level investors.",
                            "Positionnez votre marque au centre des relations commerciales Nigeria-Maroc. Présentez vos produits à des investisseurs de haut niveau."
                        )}
                    </p>
                </div>
                ...
                <div className="relative z-10 flex-shrink-0">
                    ...
                    >
                <span>
                    {getTranslation("bookButton", "Book A Space", "Réserver un Espace")}
                </span>
